                              ...
                              onPressed: () {
                                Provider.of<Journeys>(context).updateJourney(
                                    ...
                                    Journey(
                                        ...
                                        hasEnded: true,
                                        tripTotal: isUserBike ? 0.0 : double.parse(cost),
                                        tripLength: journey.startTime.difference(DateTime.now()).inMinutes.toDouble().abs() //< 0 ? journey.startTime.difference(DateTime.now()).inMinutes.toDouble() * (-1.0) : journey.startTime.difference(DateTime.now()).inMinutes.toDouble()
                                        ),);
                                setState(() {
                                  _t.cancel();
                                  _timeString = null;
