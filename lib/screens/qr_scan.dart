...
class QrScanState extends State <QrScan> {
        ...
        body :  Container (
          child :  Column (
            ...
            Padding(
              ...
              child: Text("Ready to ride? Find the QR code on the bicycle lock and unlock your ride to start your journey.",
  ...
  Future scan() async {
    try {
      ...
      setState (() => this._barcode = 'null, the user pressed the return button before scanning something)' );
    } catch (e) {
      setState (() =>  this._barcode = 'Unknown error: $e' );
    }
  }
